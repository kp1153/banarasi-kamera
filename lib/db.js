...
export async function initDB() {
  ...
  try { await db.execute("ALTER TABLE blog_posts ADD COLUMN cover_image TEXT"); } catch(e) {}
  try { await db.execute("ALTER TABLE blog_posts ADD COLUMN gallery TEXT"); } catch(e) {}
}
